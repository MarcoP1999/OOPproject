...
Fatto ciò il JSON è stato convertito in una lista di stringhe ciclo per iterare il processo di parsing dei dati ricevuti con l'API get_metadata e creare un JSONArray in modo da ottenere un buon quantitativo di dati per l'elaborazione. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ0ODYyNjk4NCw2MDIxNTM2NDAsMTMzND
