...
public class Filtri {
	...
	/**
	 * Metodo per verificare che l'elemento in analisi sia stato modificato
	 * nell'intervallo di date giusto
	 * 
	...
	public Boolean FiltroData(Calendar c1, Calendar c2, Calendar c3) {
		...
		if (c1.compareTo(c3) >= 0 && c3.compareTo(c2) >= 0)
			return true;
	...
	public Boolean FiltroAltLargh(Long alt, Long largh, Long altObj, Long larghObj, String operatore) {
